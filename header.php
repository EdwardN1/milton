                            ...
                            <div id="utility-bar">
                                <div class="grid-x">
                                    ...
                                    <div class="cell shrink social">
                                        ...
                                        ?>
                                        <?php if ($facebook): ?>
                                            <a href="<?php echo $facebook['link']; ?>" target="_blank"><img src="<?php echo $facebook['icon']; ?>"></a>
                                        <?php endif; ?>
                                        <?php if ($linkedin): ?>
                                            <a href="<?php echo $linkedin['link']; ?>" target="_blank"><img src="<?php echo $linkedin['icon']; ?>"></a>
                                        <?php endif; ?>
                                        <?php if ($twitter): ?>
                                            <a href="<?php echo $twitter['link']; ?>" target="_blank"><img src="<?php echo $twitter['icon']; ?>"></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
